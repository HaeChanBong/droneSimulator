...
land_matrix = numpy.empty(shape=(20, 20), dtype=int)
...
def are_visitable(x,y):
    ...
    neighbours = [(x,y-1),(x,y+1),(x-1,y),(x+1.0,y)]
    good_neighbours = []
...
def draw_objects():
    ...
    global tx, ty, maxdx, maxdy, unmoved, tileScale, txt, c, temp_x, temp_y
    global oldp, prev_pt
    global objectId
    ...
    if unmoved:
        ...
        # if you don't have good nieghbors.
        else:
...
sx,sy=15.5*tileScale, 15.5*tileScale # over the river
prev_pt = [sx,sy]
